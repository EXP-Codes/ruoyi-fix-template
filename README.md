...
<h4 align="center">基于 SpringBoot 开发的轻量级 Java 快速开发框架</h4>
<p align="center">
...
它一款可以用于所有 Web 应用程序的后台管理系统，如网站管理后台、网站会员中心、CMS、CRM、OA 等等。

此版本为**非前后端分离**版本，所有前端后台代码封装过后十分精简易上手，出错概率低。同时支持移动客户端访问。
